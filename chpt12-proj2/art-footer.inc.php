         ...
         <div class="col-md-3">
            ...
            */
            ...
            echo "
                    <div class=\"media\">
                    <a class=\"pull-left\" href=\"#\">
                    <img class=\"media-object\" src=\"" .$recentOrders['filename'] . "\" alt=\"...\">
                    </a>
                    <div class=\"media-body\">
                    <p class=\"media-heading similarTitle\"><a href=\"#\">" . $recentOrders['title'] . "</a></p>
                    <em>". $recentOrders['time']. " minutes ago</em>
                    </div>
                    </div>
            ";
            }
